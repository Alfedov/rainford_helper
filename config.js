module.exports = {
  OWNER_IDS: [651049944009932800], // Bot owner ID's
  PREFIX: ".!", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/4DWHGwQY5v", // Your bot support server
  PRESENCE: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "970968537734709269", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
